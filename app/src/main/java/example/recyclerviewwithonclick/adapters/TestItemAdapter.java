package example.recyclerviewwithonclick.adapters;
...
import example.recyclerviewwithonclick.R;
import example.recyclerviewwithonclick.models.TestItem;

public class TestItemAdapter extends RecyclerView.Adapter<TestItemAdapter.MyViewHolder> {
    private List<TestItem> mTestItemList;
    private View.OnClickListener mOnItemClickListener;

    public TestItemAdapter(List<TestItem> testItemList) {
