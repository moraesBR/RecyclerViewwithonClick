package example.recyclerviewwithonclick;
...
import example.recyclerviewwithonclick.adapters.TestItemAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestItemAdapter recyclerViewAdapter = new TestItemAdapter(mTestItemList);
